...
#define    MENU                   TRUE
#define MENU_CUSTOM            "Copy", "Paste", "Separator", "Add tab" , "Remove tab", "Seperator", "Reset terminal" , "Toggle anti-alias" , "Submenu input method"
...
#define TAB_EXPANDED_WIDTH     FALSE
#define TAB_LABEL              "%u" /* %u will be replaced by numbers */
#define TAB_LABEL_DYNAMIC      FALSE      /* for xterm escape sequences     */
// #define TAB_BORDER             0
...
#define TABBAR                 TRUE
#define TABBAR_PLACE           RIGHT    /* Options: TOP, BOTTOM, LEFT, RIGHT */
#define TABBAR_AUTOHIDE        FALSE
...
#define    HOTKEY                       TRUE
#define HOTKEY_COPY                  CTRL_ALT(GDK_y)
#define HOTKEY_PASTE                 CTRL_ALT(GDK_p)
#define HOTKEY_FONT_BIGGER           CTRL_ALT(GDK_Page_Up)
#define HOTKEY_FONT_SMALLER          CTRL_ALT(GDK_Page_Down)
#define    HOTKEY_TAB_ADD               CTRL_ALT(GDK_t)
#define    HOTKEY_TAB_REMOVE            CTRL_ALT(GDK_w)
#define    HOTKEY_TAB_PREVIOUS          CTRL_ALT(GDK_j)
#define    HOTKEY_TAB_NEXT              CTRL_ALT(GDK_k)
...
//#define HOTKEY_RESET_TERMINAL        CTRL_ALT(GDK_u) || CTRL_ALT(GDK_U)
#define HOTKEY_RESET_AND_CLEAR        CTRL_ALT(GDK_u) || CTRL_ALT(GDK_U)
